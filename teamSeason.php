	...
	if ($_SESSION['logged_in']) {
		...
		if (mysql_num_rows($res)) {
			...
			print "<tr><td colspan='2' align='center'><em>With selected:</em>
					<table>
					<tr><td><input type='radio' name='actn' value='del' disabled='true'>Delete</td></tr>
					<tr><td><input type='radio' name='actn' value='drop'>Drop from this season</td></tr>
					<tr><td><input type='radio' name='actn' value='rollover' checked='true'>Rollover to next season</td></tr>

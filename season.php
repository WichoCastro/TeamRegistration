<?
	...
	if ($_SESSION['logged_in']) {
		...
		$res=mysql_query($sql);
		print "<form method='post' action='season.php'>";
		...
		while ($rec=mysql_fetch_array($res)) {
			...
			print "<td><a href='season.php?editSeason=1&season_id=".$rec['uid']."'><img alt='Edit' src='images/pencil.png' title='Edit Details' border='0'></a>";
